...
[[http://markforster.squarespace.com/][see his blog here]] *email:* [[mf@markforster.net]] Read More about it in the *☞ About:* Binder below...
...
2) [ ] *DO Boilerplate AF TODO Tasks Within ✅ AF Notebook - Page 1:*
...
=These Instructions Were Last Modified:= <2022-11-03 Thu> 
...
- [[#-af-notebook][✅ AF NOTEBOOK:]]
   - [[#-af-notebook---page-01-08][✅ AF Notebook - Page 01:]]
      ...
      - [[#03--copyclone-a-new-todo-item][03 ☞ Copy/Clone a NEW TODO Item:]]
      ...
      - [[#08--remove-all-these-demo-tasks-and-start-this-page-clean][08 ☞ Remove All These Demo Tasks And Start This Page Clean:]]
...
** 📚 References:
:README:
   Use this section to include links to Important References that
   are GLOBAL to this ENTIRE Autofocus Notebook...
:END:
...
<<AFN-Page-01>>
*** 00 ☞ BOILERPLATE TODO Item: /(/Copy/Clone for NEW AF TODO Item)/  :noexport:
<<P0-00_AFN-TODO-Item>>
:README:
=Instructions...=
...
being a real AFN TODO Item which would start at number ~01~... Real Autofocus TODO Items are numbered from: ~01~ to: ~25~ and should Only Contain One Or Two Sentences with a link to more info... And that would be ALL... This :README: drawer /(which contains a volume!)/ would NOT be included in your REAL AF TODO Items... 
...
It is initially at the Top of the list, but You may choose to keep this template on top or on bottom of your list... That is your preference...
I am keeping mine on top but I have been known to change my mind... %^)

I don't think it really matters. What matters is it is there to copy and save you a lot of time for the real Autofocus work...

This BOILERPLATE Item does NOT appear within the TOC above so it is not in your face while you are doing your normal Autofocus Sessions...

=Add NEW AF TODO Items to the HEAD of Your CURRENT PAGE:=

=Note:= /Don't Add Over 25 Entries Per Page!/

=Over 25 TODO Items already?= *Start a New Page:*
Follow Instructions in the [[AFN-Page-00][:README:]] drawer under:
*✅ AF Notebook - Page 00* /(above)/ instead...

=Still Less than 25 entries?= *Continue Below:*

- [ ] =Copy Paste:= *00 ☞ BOILERPLATE TODO Item:*

      /(i.e., this heading and all content)/ to the =HEAD= of your latest
      unfilled *AF Notebook Page*... Rename your copy to intended task
      name and change ~00~ to the next number at the HEAD of your AF TODO
      Items List...

- [ ] *Feel Free to Remove this README Drawer from CLONES!*
      You can always find these instructions in this read-only
      template... It is important NOT to clutter up your AF TODO
      Items... They need to be kept short and sweet one liners!

=Linking Autofocus Item <-with-> Details Note or Ext .org Doc:=

For quick navigation to and from your Autofocus Page List from tasks you are working on, you need some cross document org-links... This template adds boilerplate forms that make it easy for you to set your links without having to type a lot of key commands etc... /(you simply change the existing links and anchors contained within these templates)/

The [[P0-00_AFN-TODO-Item_DETAILS][Follow This Link]] Link /(directly under this :README: drawer)/ links to a *MORE DETAILS Heading* for this GENERIC Autofocus TODO Item.

       /ALL OF THIS IS BOILERPLATE FOR YOU TO COPY AND USE/

The Link below takes you back to the: ~<P0-00_AFN-TODO-Item_DETAILS>~ anchor
which is the default for the BOILERPLATE Template note...

- [ ] =Use the existing Anchor:= ~<P0-00_AFN-TODO-Item>~ /(under HEADING above)/
      as the =KEY= to emulate as you change it to reference your NEW
      AFN page number & TODO Item number... as well as the anchor to
      your renamed AFN TODO Item Details Note... both anchors should be
      identical except ~_DETAILS~ is tacked on to the end of the anchor
      for the MORE DETAILS Note...

      ~P0~ = The Page Number /(P0=boilerplate template)/...
           Start yours at ~P1~

      ~-00~ = The Item Number /(00=boilerplate template)/...
            Actual Items must be ~01~ to ~25~ only

- [ ] =Change Anchor Title:= ~_AF-TODO-Item~ Replace this part with the real
      title of your TODO Item using a leading underscore to connect to
      Page and item number, and use dashes between words in the title...
      
- [ ] =Rename more DETAILS Note Anchor:= Copy the anchor you just created
      above for this heading above, and add ~_DETAILS~ to the end of it
      to make the anchor to this AFN TODO Item's DETAILS Note...

This will insure all your "read more" notes or external .org docs point back to a single specific Autofocus TODO Item heading /(exclusively)/...

- [ ] =Read Additional Instructions BELOW under this :README:=
:END:

[[P0-00_AFN-TODO-Item_DETAILS][Follow This Link]] and read the :README: just above where your cursor
ends up after clicking the link... /(or simply follow steps below/
/for quick usage)/

The README provides detailed instructions for setting things up,
linking to external docs, etc... 

=Important= *THIS IS BOILERPLATE...* =Do NOT REMOVE or ALTER= this:
          *00 ☞ BOILERPLATE TODO Item:* from your Notebook Pages...

          Once a page reaches 25 items you no longer need this boilerplate
          to create more Items because this page is full...
          
          Its OK and tidy to remove this BOILERPLATE from FULL AFN Pages.
          /(but it does not hurt if you leave it)/

=Quick Instructions:= /(to add A NEW AF TODO Item to this PAGE)/
...
- [ ] =Copy Paste:= *00 ☞ BOILERPLATE TODO Item:*
      ...
      /(i.e., this heading and all contents)/ to the =HEAD= of your latest
      unfilled *AF Notebook Page*... Rename your copy to intended task
      name and change ~00~ to the next number at the HEAD of your AF TODO
      Items List...

- [ ] =Edit your NEW CLONED AFN TODO Item= to replace this note and ALL the
      rest of the LONG TEXT below it with a SHORT one-liner description
      of your real AFN TODO Item Task...

- [ ] =EDIT/REUSE= the anchor & "Follow This link" /(above)/ so it will work
      with your new renamed ~Px-xx_YOUR-TODO-Item_DETAILS~ anchor...

- [ ] =Remove= the *:README:* drawer /(above)/ from your clone of this
      BOILERPLATE once you have it all set up as an actual AF TODO
      Item...

- [ ] =Remove this:= *00 ☞ BOILERPLATE TODO Item:* after you have reached
      a full 25 Items on this page... You won't need it in here anymore...
      /New pages created will contain this same boilerplate item once you/
      /have created them from the/ *✅ AF Notebook - Page 00:* /(template)/...
...
/Read the Quick Start Instructions within the/ *⎘ Meta:* /Binder, below to get started.../ [[AFN-Quick-Start][Follow This Link]] to go there directly from here...

*** TODO 03 ☞ Copy/Clone a NEW TODO Item:
...
- [ ] =Change Item Number:= From ~00~ to the next consecutive
      number at the end of this list, /(i.e.,/ ~09~ /)/
...
- [ ] =Follow Instructions:= within: [[P0-00_AFN-TODO-Item][:README:]] drawer of:
...
- [ ] =Follow Instructions:= within the [[AF-Page-00][:README:]] drawer of your new
      Cloned *✅ AF Notebook - Page* for detailed instructions to finish
      setting up...

*** TODO 07 ☞ Read Full Instructions:
/Read: *📄 Full Instructions:* within the/ *⎘ Meta:* /Binder, below/ /as a final task when you have time to focus on all of this.../ /It is IMPORTANT to make a point of reading the Full Instructions/ /in order to get a deeper understanding of this interesting human psychological process.../

*** TODO 08 ☞ Remove All These Demo Tasks And Start This Page Clean:
/Put your OWN TODO Tasks in here and start using this AF Notebook for real.../ You might probably leave 06 ☞ Start A New Page After
25 Items to do once you have that many items... ;-)
* 📝 AFN DETAILS:                :noexport:
** ✅ AFN Page 01
*** P0-00 ⏱ AFN TODO Item Details: /(BOILERPLATE template)/
<<P0-00_AFN-TODO-Item_DETAILS>>
:README:
☞ =Instructions:= /(How to Use This BOILERPLATE template)/

To use this *P0-00 ⏱ AFN TODO Item Details:* /(BOILERPLATE - /template)/ for your own projects, perform the following steps: /(Use the org-mode Checkboxes to Help You Keep Track of Progress)/

1) [ ] *Clone a Copy of This Boilerplate Heading:* /(and all sub-content)/

      =DON'T DELETE OR MODIFY This BOILERPLATE Template!=

      =Copy:= *P0-00 ⏱ AFN TODO Item Details:* /(this heading and sub-content)/

      Place your clone directly under this BOILERPLATE Template, or at the
      Bottom of the list of previous TODO Item Details Notes just like this.

      =Rename your clone= to: ~Px xx ⏱ Task-Title DETAILS:~ where the first ~x~
      is the Autofocus page number where this task appears, and the
      second ~xx~ is the number of this new TODO Item on that page...
      Numbered from: ~01~ to: ~25~ only...

      =Rename Title portion:= ~Task-Title~ /(after stopwatch)/
      Replace this part with the real title of your TODO Item, Leave
      DETAILS to distinguish between this note and the AFN TODO Item
      itself...

      ALL of your "read-more" details notes for your Autofocus TODO Items
      will be placed within this *📝 AFN DETAILS:* Binder, under their
      respective AFM Page No. sub-headings...

      Use this BOILERPLATE heading to create more unique "read-more"
      details notes linked exclusively to their associated TODO Items
      within The *✅ AF NOTEBOOK:* Binder...

      Place these new TODO Item Details Notes under the *✅ AFN Page 01*
      heading until there are no more items left to write details
      about... Once you begin working through a new Page 2, place your
      TODO Item Details Notes under: *✅ AFN Page 02* heading which is
      already below.  When you get to Page 3 Add a new  *✅ AFN Page 03*
      Continue in this way adding new page headings as needed...

3) [ ] =Adjust:= *RETURN TO AF Notebook ITEM* =link= /(below)/

     This is the first thing you will see under this :README: drawer...
     below.

     Use *xah-fly-keys* leader key command: ~SPACE b~ to toggle Link
     expansion, allowing you to edit the link manually... The link will
     expand showing: [[P0-00_AFN-TODO-Item][RETURN TO AF Notebook ITEM] ]

     Change: ~P0-00_~ to ~P1-xx_~ /(reflecting Page number & TODO Item number)/
     of its actual AFN TODO Item...

     Change: ~AFN-TODO-Item~ /(reflecting default TODO Item title)/
     of the default boilerplate TODO ITEM anchor, to the NEW Title
     of your NEW AF TODO Item... /Make sure this link matches your/
     /anchor and titles match the Item Heading.../

     Getting this link working correctly is vital to proper use of
     your Autofocus Notebook...

4) [ ] *Compose your Autofocus Notebook TODO Item details:*

      Next... Compose your details in the space directly under the
      *RETURN TO AF Notebook ITEM* link... /(which you just edited)/

      Use as much space as needed... This is NOT a one liner...
      You get to this spot ONLY when your autofocus session
      leads you here... And when that happens you are "on task" so
      get to it... ;-)

      Remove all the existing instructions under the link and replace
      that with your own content...  Have fun!

=These Instructions Were Last Modified:= <2022-11-04 Fri>
:END:
- [[P0-00_AFN-TODO-Item][RETURN TO AF Notebook ITEM]]

=Compose AutoFocus Notebook TODO Item Details HERE=
...
- *Link to Project LOGS:* [[../HAP_General-Log-Book-Skeleton.org::Generic-Title-LOG][Generic-Title-LOG]]
...
=Empty Placeholder Page= Put NEW *Px-xx ⏱ AFN TODO Item Details:* in here for new AFN TODO Item Details Notes for AFN Page 2...
...
=Note:= These instructions originally came from the *Main Autofocus Website*
      /(see link in:/ *📚 References:* /under the/ *☞ About:* /Binder above...)/
...
- [ ] =Cross The Item Off The List:= /(if task is DONE)/

      This is much easier to do here in org-mode than if you were using
      a paper spiral notebook, and coloured pencils...

      Instead of crossing it off where it exists, simply move it to the
      HEAD of the list on your current unfilled Auto Focus Page and change
      its Item number from where it was, to the next available number
      /(up to 25)/ on this new unfilled page...
...
- [ ] =Continue Going Round The Same Page:=
      ...
      ~:noexport:~ This causes them to automatically fall away from the
      ...
      for a bit but the task is not 100% complete yet...
...
*📄 Full Instructions*. but I suggest you get going now and read the
...
- [ ] =Follow= [[P0-00_AFN-TODO-Item][:README:]] =Instructions= Under: *00 ☞ BOILERPLATE TODO Item*
      below /(to add new TODO Item, etc.)/...
