...
- The three provided tasks below are general default tasks that should be started as soon as you create a new project based on this HAP-Book-Project-Skeleton... They appear here offering a "bootstrapped" head start and also to provide some guidance about starting your new book projects with a fresh better organized process... 
:END:
