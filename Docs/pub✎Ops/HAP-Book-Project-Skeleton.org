...
**** ACTIVE Step One - Write a Single Sentence Summary:
:LOGBOOK:
...
1. Take an hour and write a one-sentence summary of your novel:   
   
   Something like this: 

   "A gourmet chef from Boston acedentally falls into a parallel world, chased by enemies not even his own and almost dies, but then discovers he is immortal, meets-re-discovers his ancient soul mate of eons, and together they save the universe after all else fails!" 

       OK I know... I cheated... that long sentence above should be broken up... The last phrase is the stinger that needs to stand alone... I often buck the rules... lol

The sentence you end up writing above will serve you forever as a ten-second selling tool. This exercise defines the big picture illustrated by the first simple triangle in the snowflake diagram (as explained to Goldilocks by Baby Bear in Randy Ingermanson
...
. It will be your pitch... To see if there is more interest...  Important closing rules for sales! The law of attraction always applies.. no pushing... 

Memorize this line to the point you can say it in your sleep... Turn it into a "slogan" (hopefully a meme if you are the lucky type). Your goal is that others will remember and tell all their friends (word for word).  

Always lead with this line alone when opening a dialog engagement with a stranger or even your mother. Remain silent after that... Wait to see if there is interest before diving deeper... That and your good body language "posture" will take care of everything...
...
**** NEW Expand Paragraph to Synopsis
:LOGBOOK:
- State "NEW"        from "DONE"       [2020-07-02 Thu 17:38]
