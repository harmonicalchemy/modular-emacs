...
Use this: "💡 Scratchpad Refile ☞ Start Here!" section as a quick place to document ideas and inspirations as they come alone.  You can refile them later... Even if your quick inspiration was intended for elsewhere?, e.g., You are bored with documenting tedious tech details and suddenly get inspired with a new sci-fi plot idea for your next screenplay!, etc.) Ummm.... Parallel universe? Sure... You got that covered here in this Start Here spot. %^)
...
*** DONE 📄 Topic - <replace w/ chapter name>
...
:README:
Topics or Scenes are the DNA that make up the chapters in a book...  
