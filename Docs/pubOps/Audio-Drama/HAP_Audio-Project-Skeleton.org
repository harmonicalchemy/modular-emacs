...
#+SETUPFILE: ~/.emacs.d/Docs/pubOps/Audio-Drama/org-templates/audio-book.org
...
#+DESCRIPTION: HAP - Bare Bones Audio Theatre Project Skeleton with generic basics already done.  Great for Authors to use when starting a new Radio Drama or any kind of Audio Production project from scratch...
...
2. *Change the* ~#+TITLE:~ *directive at the top of this file* to /"Your Audio Drama Project's Title"/

3. *Change the* ~#+EXPORT_FILE_NAME:~ *directive at the top of this file* to /"Your-Audio-Drama-Project's-Title.pdf"/ That will be the file name produced on export thence forward...

4. *Change the* ~#+DESCRIPTION:~ *directive at the top of this file* to /Your-Audio-Drama-Project's Description/ etc...
...
3. *Copy/Clone ./bin* /(and all its contents):/ To your new project's folder /(where you copied this file).../  This is needed for running scripts that convert your ~.fountain~ scripts into PDF or other formats...
...
6. *Start Planning / Writing Your Audio Drama:* /Change headings and structure to match your project's outline sections-chapters-scenes-plots-characters, etc./ Start doing the Tasks within the Tasks section... Have fun doing this...
...
- *To export a PDF issue the following Emacs command:*
...
After *AucTeX* is done parsing/compiling etc., a new *PDF* by the name of ~My-New-Audio-Drama.pdf~ -and- ~My-New-Audio-Drama.tex~ will appear within the same directory as this file...

Subsequent repeated calls to the above command will overwrite your existing ~New-Untitled-Book.pdf~ -and- ~New-Untitled-Book.tex~ files! You should probably copy these files to the ~./auto/~ directory as well for safe keeping as backups...
