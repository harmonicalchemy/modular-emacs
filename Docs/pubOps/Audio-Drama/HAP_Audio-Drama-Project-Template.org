...
- *Sound Cue Numbering Convention:*
   ...
   Its easy to call out these cues during a rehearsal... For instance, simply saying: "SFX 1, 12, 25" and everyone will know we are talking about Episode 1, Scene 12, Cue 25... 

    ~[SFX-E01-S01-01]~
      |   |   |   |_____ /Sound Cue # (99 possible cues per scene)/
      |   |   |_________ /Scene # (99 possible scenes per episode)/
      |   |_____________ /Episode # (99 possible episodes per story)/
      |_________________ /Mnemonic for: sound effect, environment sound, etc./

:END:

***** Scene 01:

****** 📢 ~[SFX-E01-S01-01]~ "sound cue name" /(template)/
:README:
...
nn     _SOUND: [SFX-E01-S01-01] ANGRY SCREAM! - SMASH BATHROOM MIRROR - SHARDS FALL IN SINK (CONTINUE AND FADE SLIGHTLY UNDER - INTENSE EMOTIONAL SILENCE) [SFX-E01-S01-02] WALLA - DEEP SOBBING EMOTIONAL BREAKDOWN_
...
:README:
   ...
   /Example:/ Angry Scream, accompanied by crashing sound of both fists smashing into the bathroom mirror with aftershock of shards falling into the sink, and finally after an intense emotional silence play: ~[SFX-E01-S01-02]~ "Walla" (Deep Sobbing emotional breakdown sound)
:END:
...
- [ ] *File Created:* 
     ...
     ~./media/SFX-E01-S01-01_Even-Shorter-Description.wav~
...
nn     _SOUND: [SFX-E01-S02-01] DOG BARKING IN STREET! - CAR WHEELS SCREECH - THUD - DOG CRIES THEN WHIMPERS (CONTINUE AND FADE)_
...
- [ ] *File Created:* 
       ...
       ~./media/SFX-E01-S02-01_Even-Shorter-Description.wav~

**** NEW 🎶 Music Cues
:README:

- *Music Cues (clips) Numbering Convention:*
   ...
   It's easy to call out these music cues during a rehearsal... For instance, simply saying: "MUS 1, 12, 25" and everyone will know we are talking about Episode 1, Scene 12, Cue 25... /(25? That's a lot of music for just one scene! LOL)/

 ~[MUS-E01-S01-01]~
   |   |   |   |_____ /Music Cue # (99 possible music cues per scene)/
   |   |   |_________ /Scene # (99 possible scenes per episode)/
   |   |_____________ /Episode # (99 possible episodes per story)/
   |_________________ /Mnemonic for: Music (clips, background, themes, etc.)/

:END:
***** Scene 01:

****** 🎶 ~[MUS-E01-S01-01]~ "music cue name" /(template)/
...
nn      _MUSIC: [MUS-E01-S01-01] MYSTERIOUS INTRO THEME (CROSSFADE AND DUCK UNDER)_
...
- [ ] *File Created:* 
     ...
     ~./media/MUS-E01-S01-01_Even-Shorter-Description.wav~

***** Scene 02:

****** 🎶 ~[MUS-E01-S02-01]~ "music cue name" /(template)/
:README:
    WRITE SHORT MUSIC DESCRIPTION IN ALL CAPS LIKE THIS
...
nn     _MUSIC: [MUS-E01-S02-01] OPTIONAL OMINOUS HIGHLIGHT OVERLAY STING (SYNC TO DIALOG "Until now...", FADE FAST - ONLY HALL REVERB REMAINS THEN SILENCE)_
...
- [ ] *File Created:*
       ...
       ~./media/MUS-E01-S02-01_Even-Shorter-Description.wav~
...
*** NEXT 🎙 Episode 02: /(to be added later)/

** NEW ✎ Production Log                                           :noexport:
:README:
  Use this space to add time stamped log note entries for any pourpose you may need... Mostly to track time working on scene dialog, research, and other development tasks within this project...

  References to the headings within this file related to tasks can be added to the tasks which are tracked within this log... 
:END:

*** NEW ✎ <2021-03-29 Mon> Title /(log entry template)/
:README:
...
** TODO 🗓 Editorial Calendar                                      :noexport:
:README:
...
01     _SOUND: [SFX-E01-S01-01] ANGRY SCREAM! - SMASH BATHROOM MIRROR - SHARDS FALL IN SINK (CONTINUE AND FADE SLIGHTLY UNDER - INTENSE EMOTIONAL SILENCE) [SFX-E01-S01-02] WALLA - DEEP SOBBING EMOTIONAL BREAKDOWN_

#+end_src

******* 🗒 Notes: [0/2]

- [ ] *Add more about this sound here:* 
      /(This part will not be added to the script, and you should probably start here first to get the rough idea sketched out)/
...
01     _SOUND: [SFX-E01-S02-01] DOG BARKING IN STREET! - CAR WHEELS SCREECH - THUD - DOG CRIES THEN WHIMPERS (CONTINUE AND FADE)_
...
01      _MUSIC: [MUS-E01-S01-01] MYSTERIOUS INTRO THEME (CROSSFADE AND DUCK UNDER)_

#+end_src

******* 🗒 Notes: [0/2]

- [ ] *Add more about this music here:* 
      /(This part will not be added to the script, and you should probably start here first to get the rough idea sketched out)/
...
01     _MUSIC: [MUS-E01-S02-01] OPTIONAL OMINOUS HIGHLIGHT OVERLAY STING (SYNC TO DIALOG "Until now...", FADE FAST - ONLY HALL REVERB REMAINS THEN SILENCE)_
...
*** NEW 👥 New Group or Faction /(template)/
