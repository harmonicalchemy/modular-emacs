...
#+BEGIN_COMMENT
 ...
 =NOTE:= 
   ...
   *SETUPFILE:* ~audio-tags.org~ is where tags are set for this project

   *SETUPFILE:* ~latex-audio-book-pdf.org~ is for LaTeX Export Configurations 
              to produce a PDF version of this entire Audio Drama as a Book
...
#+SETUPFILE: ./org-templates/latex-audio-book-pdf.org
...
1) [ ] *Copy/Clone ALL of the:* ~../Audio-Drama~ *Folder:* /(and its contents)/ 
...
Your Printed output will not be a book, but rather printable drama scripts
which will be discussed in detail later... 

For other Book Projects here in the PubOps section, We will get fancy trying out other eBook formats later...
...
:README:
   ...
   quickly as possible using templates designed to help you
   sketch up ideas focused on Audio Drama Projects.  A basic
   bare bones IDEAs Template is also provided for you to use
   and design for any purpose of any scope!

- =SCENES Shortcut Template:=  /Use This If You Have A New Scene Idea/
...
- =NEW IDEA Template:= /Use This For Anything You Want!/
...
** NEW 💡 New Scene Ideas:
*** NEW 🎙 ~S???~ <2022-09-09 Fri>  Scene Title /(Template)/
:README:
...
\newpage
* 🎙 Production: /(Name of Production)/                    :export:
** NEW 📃 Synopsis:
:README:
   =Use This Space to keep your Audio Drama's Synopsis...=
   ...
   - [ ] *Place Resulting Synopsis in Here:*
         ...
         to HERE to serve as this Story's OFFICIAL SYNOPSIS...

   When you are done with these Synopsis tasks, you will have 
   completed half the battle of producing your Audio Drama! The 
   other half is getting to know your characters... Plots, 
   Episodes, and scenes will flow from that effortlessly...

   You will be coming back here to consult these notes for many 
   things as you promote the premere performance of your work.
:END:
...
** NEW 🎙 ~E001~ Episode Title: /(MASTER TEMPLATE - Change Title)/
:README:
   *🎙 Episodes* are the *Top Level Headings* within the *🎙 Production:* Binder 
   of this *Emacs Org-mode* Audio Drama Publishing project...

   =Usage:=

   - [ ] =Clone This:= *NEW 🎙* ~E00n~ *Episode Title:* /(MASTER TEMPLATE)/ 
          =Copy ALL its contents= and =paste= it as a child Item 
          in the *🎙 Production:* Binder of this Audio Drama 
          Publishing Project... 
   ...
   - [ ] =Edit Your New Clone:=
          ...
          structure of *Episode / Scenes* intact... 
          /(i.e., change names only...)/
:END:
*** ☞ Episode References:                                          :noexport:
:README:
   =Org Mode Links Tip:=
...
*Add links to Anything Deemed Important to the Writing of This Episode:*
...
\newpage
*** NEW 🎙 ~S001~ Scene Title: /(Template - Change to Actual Scene Title)/:
:README:
   Here is the =ULTIMATE MASTER WORKSPACE= for creating, developing, and 
   updating a *new scene*...
...
** 📝 Episode Final Drafts: /(Links to FULL EPISODE Drama Scripts)/
:README:
   =Org Mode Links Tip:=
...
:README:
   ...
   =USAGE=
      ...
      =Into This:=   *🗓 Production Log:* Binder
:END:
...
* ⏰ Tasks:                                                          :export:
:README:
   This Tasks Section is similar to the *🗓 Production LOG* within 
   the *🔍 Research:* Binder of this Audio Drama Project...  Log entries
   are research activities...  Tasks are more General and relate to 
   this ENTIRE Production Project as a whole...
   ...
   - *Use this Section to* =ADD TIME STAMPED TASKS= *for any pourpose*
      ...
      + Create More *⏱ New Task:* =Entries= under =Sub Categories= 
         as needed during the development of your Audio Production...
...
- [ ] *Copy one-page skeleton from:* =Step Three= above to: *📃 Synopsis:* 
       inside the *🎙 Production:* Binder...

       when you are done with these Synopsis tasks, you will have 
       completed half the battle of producing your Audio Drama! The 
       other half is getting to know your characters... 
       Plots and chapters will flow from that effortlessly...
...
** NEW 🎙 ~E???~ Episode Title /(MASTER TEMPLATE - Change Title)/
:README:
   *🎙 Episodes* are the *Top Level Headings* within the *🎙 Production:* Binder 
   of this *Emacs Org-mode* Audio Drama Publishing project...
   ...
   - [ ] =Clone This:= *NEW 🎙* ~E???~ *Episode Title:* /(MASTER TEMPLATE)/ 
          =Copy ALL its contents= and =paste= it as a child Item 
          in the *🎙 Production:* Binder of this Audio Drama 
          Publishing Project... 
...
\newpage
*** NEW 🎙 ~S???~ Scene Title /(Template - Change to Actual Scene Title)/
:README:
   Here is the =ULTIMATE MASTER WORKSPACE= for creating, developing, and 
   updating a *new scene*...
...
=Paste As: New Entry= Within: *🗓 Production Log:* Binder
