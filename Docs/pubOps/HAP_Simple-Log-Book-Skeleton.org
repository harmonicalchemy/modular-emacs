...
#+DESCRIPTION: HAP - Modular Emacs Org Mode Simple Log Notebook Template.  This is a minimalist version of: HAP_General-Log-Book-Skeleton.org (a Full Featured Look Book Skeleton Template).  This log book does not have all the bells and whistles of HAP_General-Log-Book-Skeleton.org This Simple Log Template is Great FOR Internal Tracking and Planning withtin Org-Mode ONLY when you don't need to be bothered with exporting to PDF etc... There are NO LaTeX directives in here. This Template's SOLE PURPOSE is for making a traditional Log useful for internal project management that does not itself get published...
...
=Setup TAGS:=
   ...
   to your parent project directory and as such, should be all set to your new: ~.../your_Simple-LOG.org_File's/org-templates/~ directory...
...
To use *HAP_Simple-Log-Book-Skeleton.org* /(Minimalist Log Notebook /TEMPLATE)/ for your own projects, =Perform The Following Steps:=
...
1) [ ] *Clone a Copy of This File:* 
      ...
      *Place this file within its own MASTER FOLDER*: =OR= place it
      ...
      by this: ~HAP_Simple-Log-Book-Skeleton.org~ file...
      ...
      If this is a =STANDALONE LOG=, Name the =MASTER FOLDER= to reflect the
      subject category that it is going to be associated with...
      /(i.e., what you renamed this HAP_Simple-Log-Book-Lkeleton.org file to)/
...
2) [ ] =Start Documenting/Logging NOW Before You Loose It!=
      ...
      first steps above, =STOP= and go immediately to the: 📒 *Simple Log:*
      Binder...
...
3) [ ] =Finish Setting Up The Rest Of This Project LATER= [0/12]
    ...
    - [ ] *Copy/Clone:* ~./org-templates~ /(and all contents)/ *to the MASTER FOLDER:*
         ...
         =WARNING!:= To avoid overwriting existing files, DO NOT COPY this
                   ...
                   *Copy this NEW directory to serve as your:*
                   =NEW Simple Log Book's MASTER FOLDER=
    ...
    - [ ] *Change the* ~#+TITLE:~ *directive at the top of this file:* 
         ...
         Change to: /"your Simple Log's REAL Title"/
    ...
    - [ ] *Change the* ~#+TEXT: Last Published:~ *TIMESTAMP at Publish Time:* 
          ...
          of the files or code that this ~Simple-Log.org~ doc refers to and
          this LOG reflects the status of that MAJOR UPDATE
    ...
    - [ ] *Change the* ~#+DESCRIPTION:~ *directive at the top of this file:*
         ...
         Compose your ~Simple LOG's~  Description as a short paragraph here...
...
4) *Purpose of the:* ~./org-templates~  *Directory:*
    ...
    /They are allready set up correctly for the Simple Log Book genre,/
    /and the category is all set as well... But you can and may modify/
    /the original files to fit your needs.../
       
    Other SETUPFILES within this directory are intended to be used by
    other document style project templates and are not needed for this:
    ~Simple-Log.org~ Document... You may remove the extra files if you wish... 
...
*** NEW 🗓 EXAMPLE Log Entry /(Cloned from TEMPLATE)/
<2021-03-29 Mon>  
<<SLOG-2023_example-log-entry>>
:README:
   =Using this Log Entry TEMPLATE:= /(logging & tracking time)/
   ...
   =CREATING A BRAND NEW LOG ENTRY:= /(from this TEMPLATE)/

   - [ ] *COPY/CLONE THIS ENTIRE:*
         
        *NEW* 🗓 *BOILERPLATE LOG Entry* /(Simple Log Entry TEMPLATE)/
   ...
   - [ ] =Change The Anchor Link:=
        ...
        match your new Log Entry's title name...
         ...
         Leave ~SLOG-YYYY_~ as the anchor's prefix /(as in boilerplate above)/
         ...
         the NEW renaed title of this new LOG Entry...
   ...
   - [ ] =Replace Titles, Anchors, & Content of Sub Headings=
        ...
        log entry, /(as you did for the Main Anchor of this Log Entry...)/
        ...
        the Log Entry Title is part of the PREFIX for anchors made to
...
**** NEW 📚 Reference:
<<SLOG-2023-EXAMPLE-LOG-ENTRY_ref>>
:README:
   =Org Mode Links Tip:=
...
**** NEW 📒 Details:
<<SLOG-2023-EXAMPLE-LOG-ENTRY_details>>

***** NEW ⏱ New Item 1 /(placeholder)/ [0/3]
<<SLOG-2023-EXAMPLE-LOG-ENTRY-DETAILS_Item-1>>
:BOILERPLATE:
...
<<SLOG-2023-EXAMPLE-LOG-ENTRY-DETAILS_Item-2>>
:BOILERPLATE:
...
<<SLOG-2023-EXAMPLE-LOG-ENTRY-DETAILS_Item-3>>
:BOILERPLATE:
...
**** NEW ⏰ Time Card:
<<SLOG-YYYY-META-ENTRY_time-card>>

#+BEGIN: clocktable :scope tree3 :maxlevel 6 :tstart "<-1w>" :tend "<+1m>" :step week :stepskip0  t :emphasize t :level t :tcolumns 3
#+END:

**** NEW ✅ Summary: [0/3]
<<SLOG-YYYY-META-ENTRY_summary>>
:README:
   This Summary is mostly to help you find things later when you
   cannot remember when or where is was done... If you go to the
   top of this file and expand all headings to show ALL content,
...
**** NEW 📒 Details:
<<SLOG-YYYY-META-ENTRY_details>>

***** NEW ⏱ New Item 1 /(placeholder)/ [0/3]
<<SLOG-YYYY-META-ENTRY-DETAILS_item-1>>
:BOILERPLATE:
...
***** NEW ⏱ New Item 2 /(placeholder)/ [0/3]
<<SLOG-YYYY-META-ENTRY-DETAILS_item-2>>
:BOILERPLATE:
...
***** NEW ⏱ New Item 3 /(placeholder)/ [0/3]
<<SLOG-YYYY-META-ENTRY-DETAILS_item-3>>
:BOILERPLATE:
