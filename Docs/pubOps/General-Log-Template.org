...
;;;
;; Setup Tag File with Category: 
;;   (replace path below with path to setup file 
;;    for your chosen category for Logging)
;#+SETUPFILE: ~/Org-Docs/00-Agenda-files/<category>-tags.org

#+SETUPFILE: ~/Documents/000-Alisha/000-GIT/My-Docs/Org-Docs/00-Agenda-files/infotech-tags.org
...
#+TAGS: templates { published unpublished } { in_ed_cal not_in_ed_cal } logs GTD Autofocus Org_Mode Writing_Resources scratchpads templates
#+FILETAGS:
#+STARTUP: overview
