...
2) [ ] *Create:* ~./media~ *sub folder in your new project's Master Folder:*
      ...
      Log book should be placed within this ~./media/~ directory...
...
:README:
   ...
   are GLOBAL to this ENTIRE Log Book... 

   =Note:= Each Log Entry ALSO has its own specific Reference Section...
         Links to refs specific to one Log Entry only, which is NOT
         about something that could be applied as a GENERAL idea
         should NOT be PUT in this GENERAL Ref section of your Log Book...
:END:

Add links to other reference, source docs, requirements, whatever, here...
