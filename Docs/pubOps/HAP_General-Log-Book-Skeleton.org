...
:LATEST_UPDATE:
  ...
  + [ ] Change this *:LATEST_UPDATE:* drawer title to *:LATEST_TEMPLATE_UPDATE:*
        within NEW CLONES of this file...

  + [X] Update the timestamp ABOVE within THIS TEMPLATE Skeleton
        /(NOT CLONES of IT)/ whenever THIS TEMPLATE has changed...

  + [ ] *COMPARE the TIMESTAMPS between THIS TEMPLATE and CLONES*

        The BOILERPLATE content within CLONES of this TEMPLATE will
        get out of sync after a while due to version updates etc...
        
        Use the ABOVE timestamp /(within the TEMPLATE and your CLONE)/
        to see if the clone's BOILERPLATE content needs to be updated
        /(brought into sync with its template)/ and then perform any
        needed updates...

  + [ ] *Update ABOVE timestamp within CLONES of THIS TEMPLATE:*

        AFTER completing above step and your clone's BOILERPLATE
        content has been brought up to date /(i.e. in sync)/ with
        its TEMPLATE... Then update the timestamp ABOVE...
        /(within your clone)/ so you will know its latest status...
:END:
:READ_ME_FIRST:
...
2) [ ] *Change Title of :LATEST_UPDATE: drawer ABOVE:*
...
4) [ ] *Copy/Clone:* ~./org-templates~ /(and all contents)/ *to your MASTER FOLDER:*
...
5) [ ] =Start Documenting/Logging what was on your mind NOW Before You Loose It!=
...
6) [ ] *Finish Setting up this Project* =LATER= [0/10]
...
=These Instructions Were Last Modified:= <2023-02-03 Fri> 
