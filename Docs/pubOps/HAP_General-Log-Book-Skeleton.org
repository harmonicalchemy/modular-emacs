...
#+TEXT: Last Published: <2022-12-23 Fri>
#+FILETAGS: templates logs published
...
1) [ ] *Clone a Copy of This File:* 
      ...
      *Place it within its own MASTER* *FOLDER* /(or within a MASTER/
      /project folder that needs a LOG...)/

      =Keep Your Clone Within This MASTER PARENT FOLDER!=

      If this is a =STANDALONE LOG NOTEBOOK=, Name the =MASTER FOLDER=
      to reflect your Log Book Project's Title and/or purpose...
...
7) [ ] =Export/Publish to PDF File:=
      ...
      After *AucTeX* is done parsing/compiling etc., a new files named:
...
=These Instructions Were Last Modified:= <2022-12-21 Wed> 
...
This one shows up in exported PDF /(for showing this BOILERPLATE dummy content)/
It is all set... for viewing your next draft... DO IT ;-)
...
|   | *Total time*                             | *0:19* |      |      |
|---+----------------------------------------+------+------+------|
| 2 | \_  /Lab Experiment Gone WRONG!/         |      | /0:19/ |      |
| 3 | \_    Summary: [0/3]                   |      |      | 0:01 |
| 3 | \_    Details:                         |      |      | 0:18 |
| 4 | \_      New Item 1 /(placeholder)/ [0/3] |      |      | 0:18 |
...
*** ACTIVE Details:
**** DONE New Item 1 /(placeholder)/ [0/3]
...
#+begin_comment
*Tip:* Add a blank line above and below the table. The blank lines should prevent a bug when converting the table with *C-c ~*.
#+end_comment

******* Example:

1. Place your cursor, a.k.a the point, inside your updated table then type *C-c ~ /(tilde)/ answer *y*. The updated table should look similar to example below:
...
2. Place your cursor inside updated table then type C-c ' and a new window or frame will appear.

3. Place your cursor inside second column and type C-c C-c < until the column is the desired width.
...
| Term      | Definition                                       |
+-----------+--------------------------------------------------+
| keyword 1 | Extra Long line definition that continues beyond |
|           |your frame width or beyond your set Olivetti line |
|           |                      width                       |
+-----------+--------------------------------------------------+
| keyword 2 | Extra Long line definition that continues beyond |
|           |your frame width or beyond your set Olivetti line |
|           |                      width                       |
+-----------+--------------------------------------------------+
...
#+attr_latex: :width 500px
      [[./media/Str-Qt-Score.png]]




#+begin_src lilypond :file MuseScore-Frescobaldi-Lilypond-Emacs.pdf :exports none
\version "2.23.12"
% automatically converted by musicxml2ly from /home/user/.OD/01-Sandbox/tmp/Test-Music-Score.mxl
\pointAndClickOff

\header {
  title =  "MuseScore Frescobaldi Lilypond & Emacs Org-Mode"
  composer =  "Alisha Awen"
  encodingsoftware =  "MuseScore 3.6.2"
  encodingdate =  "2022-09-24"
}
...
PartPOneVoiceOne =  {
  ...
  \stemUp fis'4 \stemUp a'4 \stemUp e'8 \stemDown cis''4 \stemDown
  fis''4 \stemDown d''4 \stemDown c''8 \tempo 4.=80 | % 2
  \stemUp fis'4 \stemUp a'4 \stemUp e'8 \stemDown cis''4 \stemDown
  fis''4 \stemDown d''4 \stemDown c''8 \bar "|."
}

PartPTwoVoiceOne =  {
  \clef "treble" \time 12/8 \key c \major | % 1
  \stemUp cis'4 r8 \stemUp c'4 r8 \stemUp e'4 r8 \stemUp e'4 r8 | % 2
  \stemUp cis'4 r8 \stemUp c'4 r8 \stemUp e'4 r8 \stemUp e'4 r8 \bar
  "|."
}

PartPThreeVoiceOne =  {
  \clef "alto" \time 12/8 \key c \major | % 1
  \stemUp gis4 r8 \stemUp ais4 r8 \stemDown dis'4 r8 \stemDown d'4 r8
  | % 2
  \stemUp gis4 r8 \stemUp ais4 r8 \stemDown dis'4 r8 \stemDown d'4 r8
  \bar "|."
}
...
PartPFourVoiceOne =  {
  ...
  \stemUp g,2 \stemDown e2 \stemUp f,2 | % 2
  \stemUp g,2 \stemDown e2 \stemUp f,2 \bar "|."
}
...
#+RESULTS:
[[file:MuseScore-Frescobaldi-Lilypond-Emacs.pdf]]

#+BEGIN_EXPORT latex
\includepdf[pages=-]{MuseScore-Frescobaldi-Lilypond-Emacs.pdf}
#+END_EXPORT
...
** NEW Generic Title /(General Log Entry Template)/
<2021-03-29 Mon>
<<LOG_Generic-Title>>
:README:
   =Using the Clocking Feature of this Log Entry=
