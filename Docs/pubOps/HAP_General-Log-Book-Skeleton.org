...
\version "2.23.82"
% automatically converted by musicxml2ly from Str-Qt-Score_2bar-Example-Template.mxl
\pointAndClickOff
...
**** ACTIVE Second Experiment [0/3]
:CLOCKING:
CLOCK: [2022-12-30 Fri 21:10]--[2022-12-30 Fri 22:42] =>  1:32
:END:
...
- *Run Code Block* Test of list item with long paragraph that extends many lines to see how indentation and folding works... Test of list item with long paragraph that extends many lines to see how indentation and folding works...
  
  Test of list item with long paragraph that extends many lines to see how indentation and folding works... Test of list item with long paragraph that extends many lines to see how indentation and folding works...

**** NEW New Item 3 /(placeholder)/ [0/3]                                       :noexport:
:PROPERTIES:
:UNNUMBERED: notoc
:END:
:BOILERPLATE:
