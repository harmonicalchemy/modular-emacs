...
3) [ ] [0/12] =Finish Setting Up The Rest Of This Project LATER= 
      ...
      - [ ] *Read Directions Under The :LATEST_UPDATE: Drawer Below:* 
           ...
           AFTER Cloning, Read and Follow Instructions contained within this :DRAWER: They are tips for managing updates to the META data contained within Clones of this Template...
      ...
      - [ ] *Follow Extra Instructions found Under the 📋 Meta: binder:* 
        ...
        =NOTE:= ~ANCHORS~ are important for *README* files as you will be referring to them often from other docs /(possibly a MAJOR doc that also refers to the thing your README is about)/...
...
:END:
:LATEST_UPDATE: 
=Last Updated:= <2025-05-29 Thu> /(this TEMPLATE IS ALL SET for Prime Time)/
