...
4) [ ] *Compose your README Content:*
      ...
      =NOTE:= You are most likely doing this because you have a project that
            ...
            steps above, =STOP= and go immediately to the: *📖 README* Binder
            below and begin writing your README documentaton NOW... 

            Consult the ~:README:~ drawer directly under the README Binder's
            heading for more instructions...
...
* 📖 README:
:README:
   *This is the Main Body of your README...* Everything under This heading
   can be published as a companion PDF... 
   ...
   *btw*, if you Have *Harmonic Alchemy Modular Emacs* fully installed and
   ...
   drawer is created for you automatically and opened...
:END:
