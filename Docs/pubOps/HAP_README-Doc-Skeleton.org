...
#+DESCRIPTION: Short and sweet README with attached Log Notebook for any project or repository that needs such a thing... Great FOR GITHUB PAGES!!! This ORG file is NOT intended to be exported with LaTeX... There are NO LaTeX directives in here... This template's sole purpose is to provide a traditional README startup document, for you to use, (usually contained with source code, but there are many other applications)... THIS is NOT for a BOOK, INVOICE, REPORT, or anything else that may need to be typeset for publishing...  Custom tailor this to fit your needs. Change the tags in default-tags.org (referenced below) as well.. to fit your needs... Enjoy!
...
3) [ ] =Finish Setting Up The Rest Of This Project LATER= [0/12]
    ...
    - [ ] *Change the* ~#+DATE:~ *TIMESTAMP at the top of this file:*
         ...
         =DO THIS AFTER EACH AND EVERY TIME YOU UPDATE CLONES of THIS FILE=

         Since this file is NOT Published to PDF, putting an automatic date
         macro in this spot /(like other/ /Modular Emacs Document Templates)/
         is not helpful...
