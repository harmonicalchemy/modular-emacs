...
:LATEST_UPDATE:
  =Last Updated:= <2023-06-18 Sun> /(this template needs work)/
...
ORG-MODE LaTeX SETUPFILE for: AUDIO DRAMA or PODCAST PRODUCTION
...
=NOTE:= All LaTeX Configurations are done here for
      portability... The ~audio-production~ class name
      itself is defined within: ~09-4-org-export-conf.el~
...
=LaTeX EXPORT CONFIG FOR: --> AUDIO Production Project PDF:=
...
- *ENABLED LATEX DIRECTIVES:*
   ...
   #+LATEX_CLASS_OPTIONS: [letterpaper, 12pt, oneside, onecolumn, openany, showtrims, final]
   ...
   =AUDIO PRODUCTION CUSTOM LaTeX CONFIG:=

   /Chapter Heading Style & Positioning:/
    #+BEGIN_EXPORT latex
...
- *DISABLED LATEX DIRECTIVES:*
  ...
  # #+LATEX_HEADER: \usepackage[colorlinks=true,urlcolor=SteelBlue4,linkcolor=Firebrick4]{hyperref}
   ...
   /Stock Attributes:/
   #+LATEX_HEADER: \setstocksize{9in}{6in}
   #+LATEX_HEADER: \settrimmedsize{\stockheight}{\stockwidth}{*}

   /Left & Right Margin:/
   #+LATEX_HEADER: \setlrmarginsandblock{2cm}{2cm}{*}

   /Upper & Lower Margin:/
   #+LATEX_HEADER: \setulmarginsandblock{2cm}{2cm}{*}
