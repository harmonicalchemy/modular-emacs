...
ORG-MODE & LaTeX EXPORT SETUPFILE for: REFERENCE Books...

=LaTeX CLASS:= ~refbook~

=Chapter Style:= ~lyhne~

=NOTE:= All LaTeX Configurations are done here for
      portability... The ~refbook~ class name itself 
      is defined within: ~09-4-org-export-conf.el~

STANDARD ORG-MODE OPTIONS For This Configuration:=

- *STARTUP ORG-MODE OPTIONS:*
...
=LaTeX EXPORT CONFIG FOR: --> Reference Book PDF:=
...
- *ENABLED LATEX DIRECTIVES:*
      
   =LaTeX CLASS & PAPER SIZE:=

    #+LATEX_CLASS: refbook
    
    #DISABLED# #+LATEX_CLASS_OPTIONS: [letterpaper, 12pt, oneside, onecolumn, openany, showtrims, final]

   =GENERAL PACKAGES - Options:=
   ...
   =BETTER SOURCE CODE LISTING STYLES:=
    ...
    #+LATEX_HEADER: \usemintedstyle{xcode}
      ...
      =RUN:= ~$> pygmentize -L styles~ /to see a list of all possible "minted" code
           listing styles.  Then change {style-name} below to try any out.../
   ...
   =FONTS:=
    ...
    #DISABLED#    #+LATEX_HEADER: \usepackage{fontenc}
   ...
   =USE Same FONT SPECS as Fiction Book Setup:=
   
    #+LATEX_HEADER: \usepackage[LGR, T1]{fontenc}
    #+LATEX_HEADER: \usepackage{libertine}
    #+LATEX_HEADER: \usepackage{libertinust1math}
    #+LATEX_HEADER: \usepackage{gfsneohellenic}
    #+LATEX_HEADER: \renewcommand{\sfdefault}{neohellenic}
    #+LATEX_HEADER: \usepackage{titlesec}
    #+LATEX_HEADER: \titleformat*{\section}{\Large\sffamily}
    #+LATEX_HEADER: \titleformat*{\subsection}{\large\sffamily}
   ...
   - =NOTE:= *See List of "minted" Code Listing Styles:*
     
           *RUN:*
                *$>* ~pygmentize -L styles~

           Then change {style-name} below to try any out...
           So Far... I found these three to work fairly well
           for my needs...
   ...
   /Include the use of Music and Chord Symbols/
    #+LATEX_HEADER: \usepackage[minimal]{leadsheets}
    #+LATEX_HEADER: \useleadsheetslibraries{musicsymbols}
    #+LATEX_HEADER: \useleadsheetslibraries{chords}
    ...
    /These were disabled because NOT found../
    /(not sure how they got in here as well - LOL)/
   
    #DISABLED#    #+LATEX_HEADER: \input{layoutsetup}
    #DISABLED#    #+LATEX_HEADER: \input{theoremsetup}
    #DISABLED#    #+LATEX_HEADER: \input{macrosetup}

   =REFBOOK CUSTOM LaTeX CONFIG:=
    ...
    #+BEGIN_EXPORT latex
       ...
       %%%% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
       %%  DISABLED DIRECTIVES (due to ERRORS etc.)
