...
#+BEGIN_COMMENT
=File:=  ~ref-book.org~ - HAP BASIC SETUP for Reference & Technical Book Projects...

        =BASIC LaTeX Configuration for: REFERENCE=

=Usage:= *Copy/Clone* this file and adjust to suit your needs...
        *Include* this file within ~.org~ files destined to become
        a *Reference Manual or Book - PDF*...

  *Add:* the following line to the Header the ~.Org~ File:

  ~#+SETUPFILE: $HOME/.emacs.d/Docs/pubOps/org-templates/ref-book.org~
