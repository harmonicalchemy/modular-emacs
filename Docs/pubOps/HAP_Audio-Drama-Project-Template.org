...
1) [ ] *Copy/Clone ALL of the:* ~../Audio-Drama~ *Folder:* /(and ALL its contents)/ 

        Copy this template folder as your ="NEW-Audio-Project"= folder... 

        You Cloned copy will have a copy of This File which you should ALSO
        rename to your specific Audio Drama or Podcast Production Project's
        REAL Title...
...
3) [ ] *FINISH SETTING UP THIS PROJECT...* [0/10]
    ...
    - *The* ~./media~ *Directory is ALL Set:* 
         ...
         also be using this ~./media/~ directory to store finished sound media, 
         ...
         exists within this folder /(for HAP Audio Project Template .org files)/
         So that is all set...
    ...
    - *Purpose of the:* ~./auto/~ *Directory:*
         ...
         This folder is auto generated during org-mode LaTeX processing...
...
So far things are pretty basic PDF which is good enough for Audio Production...
...
=Note:= The following is an example of an idea that /(actually did come up)/
      while I was in the process of designing and producing these Org-Mode
      based Project Skeleton Template Files for Independent Authors, Writers,
      etc... It is documented here now...

      I can come back later and put it where it belongs, and then continue
      on with it.... /(when that time comes)/ It is Tagged ~:must_read:~
...
:README:
   ...
   completed half the battle of producing your Audio Work!
   And you will have a pretty good abstract 
   
   Everything else you write will flow out of that initial seed...

   You will be coming back here to consult these notes for many 
   things as you promote and publish your production.
:END:
...
:README:
   ...
   Use this space to write the *Introduction* to your Audio Production...
   When published, this *Introduction* will appear before *Episodes*...
   
   It should include anything production managers, directors, actors,
   narrators, sound designers, composers, producers, executive producers,
   casting directors, etc., and any interested readers will need to get
   started with a solid overview of this entire audio production...

   The published version of this book will contain everything needed, and
   the full Drama Script will be exported via an external ~.fountain~ script
   file... which produces a separate printable *PDF* script in CURRIER font
   that could be included here as well...

   Many Sections within this project /(that are NOT exported)/ contain fountain
   script source code blocks, /(where the story is developed in stages)/ and
   later put into the master ~.fountain~ script file...

   =WARNING:= Do NOT Remove the ~#+BEGIN_EXPORT latex~ Directive at the end of
             this Preface...  It is needed to mark the end of LaTeX Frontmatter
             and the Beginning of the Mainmatter *The Episodes*...
:END:
...
:README:
   ...
   *Episodes* are the *Top Level Headings* within this *Emacs Org-mode*
   Audio Drama Production Project... Built in LaTeX memoir styles
   insure that Episode and Scene numbering work without needing any
...
- [ ] *USAGE:* [0/2]
   ...
   1) [ ] =Clone This:= *NEW Episode Title A:* /(BOILERPLATE)/
...
:README:
  Compose a new draft scene fountain script in the block below... Write some scene related production notes, or instructions within the fountain script source block as well... The snippit you compose below will be added to the
  final production script later, but this is the initial SOURCE where you
  write the script for this scene...
:END:
...
:README:
   This section is for a episode's Back Story development... 
...
=Note:= This is an example of a back story related to this 
      episode, or possibly connecting to another episode 
      in your book... 
...
:README:
   ...
   Not Intended to be Added back to the Episodes/Scenes of your 
   ...
   episode, will help you get better organized about how your book 
...
=Note:= All Audio Drama Projects based on this Template will use the same 
       rules.. If identical Sound clips are needed by other projects, you
       ...
       /ONLY look for sound clips within their OWN MEDIA Folders).../
       ...
       the sound files are not HUGE!!! If they ARE HUGE you may be better 
       to use a simlink...

       The actual sound file names will NOT contain Episode or Scene number,
       but WILL contain the Sound Cue Number, AND a very short description 
       of the sound itself...

       You have 999 different possible Sound Cue Numbers, which should be more than enough when combined with a short description to make ALL sound
       ...
       ready sound files for any given project shall be kept in the
...
=Note:= Many *"stock"* sounds occur normally within multiple Episodes 
       throughout a production project... These identical sound files are 
       identified within the script by looking at the Cue number which 
       MUST be UNIQUE within any given project... The Episode and Scene
       numbers may change but if the Cue Number is the same you know
       that it refers to a single sound file /(used multiple times within
       the script)/

=Sound or Music?= Sometimes it is hard to decide whether a sound clip
                  is "music", "background sound", or "sound effect"
...
1) [[./HAP_Radio-Script-Template.fountain][LINK TO E001 FINAL DRAFT - EXAMPLE Fountain Script]] 

2) [[./HAP_Radio-Script-Template-w-instructions.fountain][LINK TO ANNOTATED Tony Palermo Style EXAMPLE Fountain Script]]
...
- [ ] *USAGE:* [0/3]
   ...
   - [ ] =FIRST: Copy Clone This BOILERPLATE= *New Scene Y:*
        ...
        Have any more Scenes to write for this LAST Episode.

        =Do NOT CHANGE ITS CONTENT!...=
        
        Paste your clone just above it, /(below your existing Scenes)/
        Your new clone will serve as your SECOND, THIRD, FOURTH, Etc...
        Scenes for this LAST Episode in this Audio Production...
...
:README:
   ...
   This FINAL *New Scene Z:* contains LaTeX directive:
   ~\backmatter~ and ~\appendix~ which means it =MUST Be placed= as the
   =LAST Scene of your LAST EPISODE in this Audio Production...=

   The LaTeX directive at the END of *Production Notes:* and BEFORE
   the 📝 *Fountain Script:* heading =MUST BE LEFT AS IS= when you are
   commandeering this FINAL Scene...
...
- [ ] *USAGE:* [0/3]
   ...
   1) [ ] =Make Sure= *New Scene Z:* is commandeered =LAST=
         ...
         Scene in the LAST Episode of your Audio Production...

   2) [ ] =Commandeer Scene Z when you are READY:=

         =WARNING= Don't Do This UNTIL you KNOW FOR SURE this will be your
                  very LAST Scene within your very LAST Episode of your
                  Audio Production... Until that time DON'T TOUCH THIS
                  Scene Z BOILERPLATE...
   ...
   3) [ ] =Change The Anchor Link= /(make it unique)/
         ...
         Leave ~SCENE_~ as the anchor's prefix...
         /(as in boilerplate anchor above)/ Use dashes to connect words
...
:README:
   ...
   =Note:= This summary is written while completing the:
         *👥 Major Characters Summary* Task located within 
         the ⏱ *Tasks:* /(Binder)/ of this Audio Production Project...
...
:README:
   ...
   + [ ] =Place CLONED= ∅ *New Planet or Satellite:* =Items= From the ⎘ *Templates:*
         heading under the 🗂 *Meta:* binder /(below)/ and commandeer
         your cloned template HERE for specific needs...
:END:
...
:README:
   ...
   + [ ] =Place= 👥 *New Group or Faction:* =Items= from the ⎘ *Templates:*
        heading under the *🗂 Meta:* binder /(below)/ and commandeer your
...
:README:
   ...
   within the episodes/scenes... This is for Research purposes... 
...
:README:
   ...
   Episodes/Scenes of your Production... This section is purely for 
   research purposes to help you while you are developing your 
   production. You may have some classic plot outlined here that 
   ...
   relating to the ENTIRE production, rather than any individual 
   episode...
:END:
...
:README:
   ...
   that you may wish to include with this series...
:END:
...
:README:
   ...
   using this: *HAP_Audio-Drama-Project-Template* 
   ...
   how to properly organize, write, and produce an audio drama with a 
...
When the time comes for you to Pitch Your Production Work, this sentence should appear very early in the proposal. It's the hook that will get executive producers coming to the table to talk business, to inspire your cast/crew, 
the sales force, the networks, and ultimately to listeners. So make the best 
one you can!
...
:README:
   =Note:= The steps below could be done to write a single
          synopsis for the ENTIRE PRODUCTION OR write 
          individual synopsis to include within EACH EPISODE 
          OR you combine BOTH methods above... /(i.e. One/
          /MASTER synopsis, and many individual EPISODE/
          /synopsis./
:END:
...
- [ ] *Copy one-page skeleton from:* =Step Three= above under the:
     📝 *Synopsis:* Heading inside the 📕 *Production Front Matter:* Binder...

     When you are done with these Synopsis tasks, you will have completed
     half the battle of producing your Audio Drama! The other half is
...
:README:
   ...
   - [ ] =STOP Everything & Go Define Your:= *👤 New Character:* 
          =Copy/Clone=: *👤 New Character:* /(Master Template)/
          from: ⎘ *Templates:* Binder within the ⎘ *Meta:*
          Binder of this Audio Theatre Project...
          
          =Paste Your Clone= to the: 👤 *Characters:* Binder located 
          within the *🔍 Research:* Binder of this Audio Theatre Project...

   - [ ] =Use Your:= *👤 New Character:* Item as the repository for the
         results of the tasks listed below. Fill in sub items:
   ...
   - [ ] =After completing each Timestamped Step= below, 
          ...
          headings within your final Character Item's Profile
          as you are working on them there...
...
- [ ] =Navigate to:= *👤 Character Bible:* Under Target:
       *👤 New Character:* which you created /(from clone)/ 
       ...
       Section of this Audio Theatre Project...
...
:README:
   ...
   =Note:= Compose This Summary within the: 
         *👥 Major Characters Summary:* /(placeholder item)/
         ...
         the *🔍 Research:* Section of this Audio Theatre Project...
:END:
...
=Note:= This is Still Under Construction... I am researching the 
      ...
      a Production Calendar work well in Emacs Org-Mode...
