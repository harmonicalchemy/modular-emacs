...
#+TITLE: HAP - Reference Book Project Skeleton
#+SUBTITLE: for reference books, tech manuals, etc...
#+EXPORT_FILE_NAME: ./build/HAP_Ref-Book-Project-Skeleton.pdf
...
#+DESCRIPTION: HAP Reference Book or Tech Manual Project Skeleton. This Template is a good choice for documenting research projects, large or small. Based on the Memoir Class. Adapted for my personal not so academic scientific methods, etc. Exports to PDF suitable for any eBook reader, or publish HTML pages to a website and-or use plugins to publish to WordPress Blog, Static engines, etc...
...
=Last Modified:= <2024-05-19 Sun>

To use *HAP_Technical-Book-Project-Skeleton.org* /(Org-Mode Reference Book/
...
1) [ ] *Clone a Copy of This File:* 
      ...
      *Important to keep this file within its OWN enclosing folder!* 
      ...
      Name the project's MASTER FOLDER to reflect your Referenc book 
      ...
      *Name This New Project's MASTER FOLDER* to reflect your Reference
...
3) [ ] *Copy/Clone:* ~./org-templates~ /(and contents)/ *to your project's MASTER FOLDER:*
      ...
      =Note:= The SETUPFILE: ~ref-book.org~ Within this directory is called
...
5) [ ] *Finish Setting up this Project LATER...* [0/9]
    ...
    - [ ] *Change the* ~#+FILETAGS:~ *directive at the top of this file:* 
          ...
          Add your own tags that match the context of your Reference Book...
    ...
    - *Purpose of the:* ~./org-templates~  *Directory:*
         ...
         /Things are currently set up for the Technical Book genre, and/
         /the Category is all set as well... But you can and may modify/
         ~ref-book.org~ /to narrow down the category more specifically,/
...
7) [ ] =Export/Publish to PDF File:=
      ...
      ~HAP_Untitled-Tech-Manual.pdf~ -and- ~HAP_Untitled-Tech-Manual.tex~ 
...
=NOTE:= 
   ...
   *SETUPFILE:* ~ref-book.org~ is for LaTeX Export Configurations 
              to produce a Reference Book styled PDF /(With TOC,/
              /& Heading Numbering at Sub Sections and Sub Sub Sections...)/
:END:
...
=Use this binder for Front Page Ideas= /(e.g., Information about Title Page, Synopsis, etc...)/, which could function as an abstract when published...
...
:README:
   ...
   =THIS SECTION COULD FUNCTION AS AN ABSTRACT when PUBLISHED=
   ...
   - [ ] *Place Resulting Synopsis in Here:*
        ...
        Tasks to HERE to serve as this books official Synopsis...

   When you are done with these Synopsis tasks, you will have 
   completed half the battle of writing your technical work!
   And you will have a pretty good abstract to publish ahead
   or for book promotions...
...
:README:
   ...
   phrase... The LaTeX style configuration for this book template
   takes care of numbering chapters and sub topics for you
   automatically...
   ...
   - [ ] =Commandeer Your Clone:= /(or this if it is your last topic)/
   ...
   - [ ] =Change The Anchor Link= /(make it unique)/
        ...
        =Note:= I created the following conventionfor making unique
...
* NEW Chapter Title A                                           :noexport: 
<<CHAPTER_chapter-title-a>>
/(BOILERPLATE Clone This)/ 
:README: 
*Chapters* are *Top Level Headings* within this *Emacs Org-mode* Book Publishing project... Built in LaTeX memoir styles insure that chapter and sub-topic numbering work without needing any of your    input... You only need to insure your anchors are unique!
...
- [ ] =Change The Anchor Link= 
     ...
     It would be wise to follow this convention when you create anchors elsewhere within ALL of your Book
           Projects created from HAP Modular Emacs Document Skeleton Template files...
...
- [ ] =Replace Titles, Anchors, & Content Within This Section= 
     ...
     Change names to suit your needs, but keep the structure of *Chapter / Sub Topic)* intact...
         
     /(i.e., change titles, anchors, and content only...)/

- [ ] =Add New Cloned Sub Topics as Needed= 

     Commandeer *Sub Topics X* & *Y* as needed when first starting out on this new chapter... Read the *:README:* drawer under the Sub Topic heading for more info...

     After that, =COPY/CLONE= *New Sub Topic Z* to make more scenes, and leave the original *New Sub Topic Z* in place =AS IS= to be cloned later to make more scenes if & when needed... Read the *:README:* drawer under the Sub Topic heading for more info...
:END:
...
:README:
   ...
   - [ ] =Commandeer This:= *New Sub Topic X:* /(COMMANDEER...)/
        ...
        =Change ALL its contents= to NEW Chapter Sub-Topic content when
        you are ready to add your FIRST Sub-Topic to this chapter...
   ...
   - [ ] =Change The Anchor Link= /(make it unique)/
        ...
        Leave ~TOPIC_~ as the anchor's prefix...
   ...
   - [ ] This *Sub Topic X* Template could ALSO Serve As =CHAPTER INTRODUCTION=
...
:README:
   ...
   - [ ] =Commandeer This:= *New Sub Topic Y:* /(COMMANDEER...)/
        ...
        =Change ALL its contents= to NEW Chapter Sub-Topic content when
        you are ready to add your SECOND Sub-Topic to this chapter...
...
* NEW Chapter Title Z                                             :export: 
<<CHAPTER_chapter-title-z>> 
/(MASTER - DON'T TOUCH UNTIL FINAL)/ 
:README: 
...
- [ ] =This item is BOILERPLATE= /(DON'T MESS with IT until THE END)/ 
        ...
        =Therefore This:= *Chapter Title Z* =Must Remain In Place AS IS= throughout the duration of your project until you reach Final Draft stage...

        *When That Time Comes, Do The Rest Of The Steps Below:*

- [ ] =Commandeer This Item as The LAST CHAPTER OF YOUR BOOK:= 

     =COMMANDEER= This item /(changing the title etc.)/ as the very last chapter in your book /(Once you know that/ /for sure)/... The *NEW Sub Topic Z* sub-heading contains LaTeX directives starting ~\backmatter~... Everyting After This chapter is BACKMATTER, /(e.g., Appendix, Index, etc...)/
...
- [ ] =Replace ALL BOILERPLATE Content Within This CHAPTER= 

     *Add Your Content:* Paragraphs, Sub Headings, Lists, Tables, Figures, Images, etc...

     =Keep the Structure Of:= *Chapter / Sub Topic)* =Intact...=

     Anything you do under *Sub Topic* Level will be automatically handled during export...

     =Note:= /You May Wish to Add your own Anchors under any headings/ /you created below/ *Sub Topic* /Level... Make them Unique!/ /You can also employ LaTeX Inline Properties to get/ /special items looking nice.../

- [ ] =Add New Cloned Sub Topics as Needed= 

     Copy/Clone & Commandeer new Sub Topics as needed to finish the chapter... Read the *:README:* drawers within Sub Topic Boilerplate Examples for more info...

- [ ] =Make Sure= *New Sub Topic Z:* /(below)/ Is COMMANDEERED as =LAST TOPIC= 

     The *New Sub Topic Z:* heading contains LaTeX directive: ~\backmatter~ and ~\appendix~ which means it MUST Be placed as the LAST Topic of your BOOK proper...

     The LaTeX directive at the end of *New Sub Topic Z* /(or title you change it to)/ must be left =AS IS= when you are commandeering the Topic to fit in as the last scene in your book...

     Do NOT touch *Sub Topic Z* until you are ready, and leave it tagged for ~:export:~ containing LaTeX directives, no matter what...
:END:
** New Sub Topic X /(COMMANDEER This One)/                         :noexport: 
<<TOPIC_new-sub-topic-x>> 
:README: 
Sub Topics are the DNA that make up the chapters in a reference or technical Book... Each new Sub Topic gets its own title or phrase... The LaTeX style configuration for this book template takes care of numbering chapters and sub topics for you automatically...

Chapters may contain several sub topics and sub topics can themselves also have sub sub topics...

=Usage:= 

- [ ] =Commandeer This:= *New Sub Topic X:* /(COMMANDEER...)/ 

        =Change ALL its contents= to NEW Chapter Sub-Topic content when you are ready to add your FIRST Sub-Topic to this chapter...

        The structure of this template is all set up for you ahead of time to allow you to immediately begin writing...

        Rename *New Sub Topic X:* to a *Unique Title* and remove /(all boilerplate content)/ in order to commandeer the entire item for your specific needs...

        Change the ~:noexport:~ tag to ~:export:~ for this NEW REAL Sub-Topic so it will show up when publishing drafts...

- [ ] =Change The Anchor Link= /(make it unique)/ 

     Change the ~<<anchor>~ /(directly under your/ *Sub Topic X* /heading)/ to match your new renamed Sub Topic title...
     ...
     If you wish to change all of this, go ahead and do what ever you want... For simplicity's sake, follow
           the instructions below... /(there are automatic ways/ /to create links and anchors within org-mode... I/ /prefer to do it manually... The alternate is a mess/ /IMHO)/

     Leave ~TOPIC_~ as the anchor's prefix... /(as in boilerplate anchor above)/ Use dashes to connect words /(all lower case)/ from your sub topic's title...

     The anchor above may be used to link to this sub topic from *Research* or other sections of this project... /(Or even from/ ~.org~ /docs OUTSIDE of this file...)/

     /(which may or may not be published as links within the PDF)/

- [ ] This *Sub Topic Template* could ALSO Serve As =CHAPTER INTRODUCTION= 

     This is optional if you need one, but its anchor link must be unique! /(i.e., NOT "TOPIC_introduction")/
:END:
...
- [ ] =FIRST: Copy Clone This BOILERPLATE= *New Sub Topic Y:*  
        ...
        Leave this BOILERPLATE *New Sub Topic Y* in place Until you No Longer Have any more Sub Topics to write for this chapter.

        =Do NOT CHANGE ITS CONTENT!...=
        
        Paste your clone just above it, /(below your existing Sub-Topics)/ Your new clone will serve as your SECOND, THIRD, FOURTH, Etc... Sub-Topics for this chapter...

        After cloning, rename *New Sub Topic Y:* to a *Unique Title* and and Replace ALL BOILERPLATE content with Your Specific topic content for this chapter...

        Change the ~:noexport:~ tag to ~:export:~ for this NEW REAL Sub-Topic so it will show up when publishing drafts...

        =Do this whenever you need to start a new sub topic...=

        =NOTE:= If you know for sure what your SECOND to LAST Sub Topic is, =COMMANDEER= This Item Instead of Copy/Clone...

        Otherwise, Once you know you are ready to start your LAST Sub Topic in this chapter, DELETE THIS: *New Sub Topic Y* Heading and all content... It is no longer needed...
        
        /(i.e., Time to Commandeer/ *New Sub Topic Z* /as your LAST Sub Topic)/

- [ ] =Change The Anchor Link= /(make it unique)/ 

     Change the ~<<anchor>~ /(directly under your renamed sub topic heading)/ to match your new renamed sub topic title...
     ...
     Leave ~TOPIC_~ as the anchor's prefix... /(as in boilerplate above)/ Use dashes to connect words /(all lower case)/ from your sub topic's title...

     The anchor above may be used to link to this sub-topic from Research or other sections of this book... /(Or even from/ ~.org~ /docs OUTSIDE of this file...)/
...
<<TOPIC_new-sub-topic-z>>
:README: 
This FINAL *New Sub Topic Z:* sub-title contains LaTeX directive: ~\backmatter~ and ~\appendix~ which means it =MUST Be placed= as the =LAST SUB TOPIC of your BOOK proper ALWAYS=...

The LaTeX directive at the end of *Sub Topic Z* /(or title/ /you/ /change it to)/ must be left =AS IS= when you are commandeering the sub-topic to fit in as the last one in your book...

Do NOT touch this special Sub Topic Z until you are ready, and leave it tagged for ~:export:~ containing LaTeX directives, no matter what ALWAYS...
...
- [ ] =Make Sure= *New Sub Topic Z:* is commandeered =LAST= 
        ...
        This Sub Topic MUST Be placed and appear as the LAST Sub Topic in the LAST Chapter of your BOOK proper...

- [ ] =Commandeer Sub Topic Z when you are READY:= 
     
     The structure of this template is all set up for you ahead of time to allow you to immediately begin writing...

     Rename *New Sub Topic Z:* /(BOILERPLATE - etc.)/ to a *Unique Title* and replace ALL BOILERPLATE with your own content in order to commandeer the entire item for your specific needs...

- [ ] =Change The Anchor Link= /(make it unique)/ 

     Change the anchor directly under your renamed sub topic heading to match your renamed sub topic title...
...
** 📝 Chapter Notes:                                                    :noexport: 
:README: 
   *Chapter Notes*, Should be written in =OUTLINE= form to aid in organization of events, etc... This section is =NOT the place to create NEW ideas=, but rather to =organize EXISTING ideas you have already written=...

   =None of the Content Written Here Should be Added to any= =Chapter/Topics within your Book= 

   =THIS IS A META PLACE=

   /(i.e., Your Books Internal Analyst/ /Behind the Curtain So-To-Speak... %^)/

   The example Notes below have been timestamped as a way to suggest organizing TODO items for a particular chapter you may find yourself working on, or researching...
...
5. [-] [0/1] =Sub CheckList...= 
      ...
      * [-] [0/2] Bullet checkbox Test one... 

           1. [-] Checkbox List item: 

           2. [ ] Checkbox List item: 

*** NEW Note 2: <2020-05-10 Sun> 

Each new note needs to get its own heading and initial timestamp...

It is fine to make as many sub-headings as needed for these notes but not important for them to also be time-stamped...
...
** 💡 New Topic Ideas: 
:README: 
Use this space to add new topic ideas that come up as you are researching ideas.  These topics will eventually get put into chapters were they belong.  This Research Binder is where they may get initially created...
...
=ADD a NEW Items= /(as per :README: above)/ right here in this New Topic Ideas Binder whenever you need to write up a new topic. /Even at the spur of the/ /moment while doing something else./ Get the idea down... Come back to finish later... You will know anything set to ~:ACTIVE:~ within this binder needs to be worked on.
...
Use this section as a place to save and organize new-ideas while you figure out what they may be for, and where they may eventually go...  

This section is a great place to start if your are importing existing docs written in markdown, or Open Office, or what ever... import the text from those external docs here first... Then you can organize them here while you figure out how they fit in the larger context of a book project...

The format for this section is anything you like.. And you may put anything you like in here.. There are NO Templates to clone for this...

=MAKE IT HOW YOU WANT TO MAKE IT HERE... ;-P=

Some of the things written *seat-of-the-pants* within the *Start Here* section may end up in this *Yak Shaving* section later when you are ready to organize things further... /(after inspiration)/
:END:
...
* 🗓 LOGS:                                                        :noexport: 
:README: 
Use this space to add time stamped log note entries for any pourpose you may need while you are planning, writing, or publishing your book...
...
- Create More *⏱ New Task:* =Entries= 
     under =Sub Categories= as needed during the development of your Project... 
...
The Synopsis Tasks provided below are important first steps to take when first starting any book.  They are based on the "Snowflake Method" by Randy Ingermanson... /(for fiction writers)/ but the universal visualization concepts apply for reference and technical works as well.

These tasks should be started as soon as you create a new project using this: *HAP_Technical-Book-Project-Skeleton* 
...
Randy Wrote his book with Novelist /(fiction writers)/ in mind but I believe these same principals apply to real-life as well... Of course... Right?  Fiction and Real Life are not ALL that
different at the end of the day... Just be sure not to be writing any "fake news" OK? Thanks... We really don't need any more of that.

=It is HIGHLY Recommended= for you to use the steps below FIRST before doing any other writing! This advise comes from many highly acclaimed authors! Not just Randy...
:END:
...
3. [ ] =The third sentence:= - *Tells them what NOT to do* 
   ...
   Here is where you get to tell some stories... past experience of failed attempts etc.  Not offering the proper solutions yet, but rather showing the palm face human events that finally lead    you to discovery of the proper methods & solutions... /(the music changes, new hope emerges out of the fog of your mess)/
...
- [ ] *Copy one-page skeleton from:* =Step Three= above to the main *📃 Synopsis:* Section of this book project... 

  When you are done with these Synopsis tasks, you will have completed half the battle of writing your technical work! Everything else you write will flow out of that initial seed...
...
Use this space to design your *EC* and then transfer it as a New Top Level Binder of this Book Project...
