...
=NOTE:= /Skip to:/ [[#-tldr---start-here][☞ TL;DR - Start Here:]]
      /if you are ready to install Modular Emacs now/
      /Skipping over Introduction, History, Purpose,/
      /etc... and you just need to get all this going now./ :trollface:
